package com.Spring.User.Service.UserService.config;

import com.Spring.User.Service.UserService.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    //declering the bean of oauth2otherizedclient manager
